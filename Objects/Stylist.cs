    ...
    public class Stylist
    {
       ...
       public void Save()
        ...
        public void Update(string newStylistName)
        {
            ...
            SqlParameter newStylistNameParameter = new SqlParameter("@NewStylistName", newStylistName);
        ...
        public static Stylist Find(int id)
       {
           ...
           while(rdr.Read())
           {
               ...
               foundStylistExperience = rdr.GetInt32(2);
           }

           Stylist foundStylist = new Stylist(foundStylistName, foundStylistExperience, foundStylistId);
